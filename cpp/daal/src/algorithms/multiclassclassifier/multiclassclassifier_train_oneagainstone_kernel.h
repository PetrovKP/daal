...
public:
    ...
    services::Status trainSimpleClassifier(size_t nRowsInSubset)
    {
        ...
        typename classifier::training::Batch::InputType * input = _simpleTraining->getInput();
...
protected:
    ...
    SubTask(size_t nSubsetVectors, size_t dataSize, const algorithmFPType * weights, const services::SharedPtr<classifier::training::Batch> & st)
